const api = {
    key: "791283ea4a5b5f683b55f82ea03bb39f",
...
function displayData(response) {
    ...
    if (response.cod === '404') {
        ...
        range.innerText = `Temp Range: ${Math.round(response.main.temp_min)}°C / ${Math.round(response.main.temp_max)}°C`;
        ...
        windSpeed.innerText = `Wind Speed: ${response.wind.speed} kw/h`;
